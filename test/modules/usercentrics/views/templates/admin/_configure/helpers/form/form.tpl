...
{block name="label"}
    ...
    <label class="control-label col-lg-3{if isset($input.required) && $input.required && $input.type != 'radio'} required{/if}">
        ...
        {if isset($input.need_help) && $input.need_help}
            <div class="">
                <a class="link" target="_blank" href="https://usercentrics.atlassian.net/l/c/YmyKHdpo">{l s='Need help?' mod='usercentrics'}</a>
            </div>
        {/if}
    </label>
    {/if}
    ...
    {if $input['type'] == 'uc_technologies'}
        ...
        <div class="col-md-6 uc-template-templates">
            <div class="uc-template-templates-header hide">
                <input type="text" name="technology" id="technology" data-placeholder="{l s='Search...' mod='usercentrics'}">
        ...
        {/if}
        <div class="col-md-12 uc-template-categories-add">
            <p class="uc-template-categories-footer">
                <button type="button" class="btn btn-default" id="open_uc_newcategory_form" disabled="disabled">
                    {$input.open_uc_newcategory_form_button_label|escape:'html':'UTF-8'}
                </button>
            </p>
            <div class="row business_coming_container">
                <p class="business_coming_msg badge badge-info">{l s='Business coming soon' mod='usercentrics'}</p>
            </div>
