                    ...
                    if (isset($routeappFee->id)) {
                        ...
                        if ($routeappFee->processed == 1) {
                            ...
                            if (isset($orderResponse['id'])) {
                                ...
                                $routeApiShipment->cancelShipment($order->reference, $routeParsedOrder['source_order_id'], $shippingNumber);
                            }
                            $response = false;
                            if (isset($shippingNumber) && $shippingNumber != '') {
                                $response = $routeApiShipment->upsertShipment($shipment['tracking_number'], $shipment, $order->reference);
                            }
